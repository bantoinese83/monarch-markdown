      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
        ...
        <div className="flex items-stretch gap-2">
          ...
          <select
            ...
            style={{
              backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%23bca9d4' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e")`,
          ...
          >
            {TONES.map((t) => (
              <option key={t} value={t} className="bg-monarch-bg text-monarch-text font-semibold">
                {t}
              </option>
            ))}
          </select>
