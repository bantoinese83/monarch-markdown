  ...
  useEffect(() => {
    if (previewRef.current) {
        ...
        codeBlocks.forEach(pre => {
            ...
            button.className = 'copy-code-button absolute top-2.5 right-2.5 p-1.5 rounded-lg bg-monarch-bg-light/80 backdrop-blur-sm hover:bg-monarch-main text-monarch-text-dark opacity-20 group-hover:opacity-100 transition-all duration-200 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-monarch-accent hover:scale-110';
